...
<script>
  $(document).ready(function(){
    $('#brain path').hover(function(){
      var title = $(this).attr('mytitlr');
      
     $('#brain path').removeClass('hover'); //removes all classes inside #brain
     $(this).addClass('hover'); //add class hover when clicked
     $('#region').html(title);
    });
  });
</script>
